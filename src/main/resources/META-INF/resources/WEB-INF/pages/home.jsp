...
<button type="submit" class ="button3" onclick ="Logout()" ><span class="bi bi-power red-color">  Logout</span></button>
    ...
    <h1 style="text-align: center;">Make a Choice</h1><br><br>
       ...
       <button type="submit" class="button1"><a href="http://localhost:8080/show_profile?username=${user.getUserName()}">Your Profile</a></button>
        
       <!--<input type="button" class="button2" value="Update Profile" onclick="update()">-->
       <button type="submit" class="button2"><a href="http://localhost:8080/get_update_form?username=${user.getUserName()}">Update Profile</a></button>
